...
class YouTubeEnv:
    def __init__(self, data_gen, max_gens=50):
    ...
    def step(self, action):
        ...
        n = len(self.state)
        idx = choice(range(n))
        video_id, self.state[idx] = self.find_closest_video(action)
        ...
        self.action_video_ids.append(video_id)
    ...
    def reset(self):
        self.state = self.data_gen.sample_videos(30)
        self.states = []
        self.actions = []
        self.rewards = []
